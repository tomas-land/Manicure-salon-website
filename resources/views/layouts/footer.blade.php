    ...
    <footer>
        <div class="column container">
            <div class="column__contact">
                <h2>KONTAKTAI</h2>
                <h4>Veiverių 150b, Kaunas</h4>
                <h4><a href="tel:+370 675 32865">8 675 32 865</a></h4>
                <h4><a href="mailto:vvirmante@yahoo.com">vvirmante@yahoo.com</a></h4>
            </div>
            ...
            <div class="column__socmedia_box">
                <div class="socmedia">
                    ...
                    <svg class="socmedia__icon socmedia__icon--fillchange" viewBox="0 0 512 512"
                    ...
                    <a href=""><svg class="socmedia__icon socmedia__icon--fillchange" height="512pt" viewBox="0 0 512 512"
        ...
        <div class="rights">© Visos teisės saugomos.</div>
